...
В качестве сервера баз данных можно использовать [Postgres Professional в контейнере Docker](https://github.com/bosenok/docker-1c-postgrespro).
...
docker exec -ti bosenok/1c-server bash
и запустите hasp
